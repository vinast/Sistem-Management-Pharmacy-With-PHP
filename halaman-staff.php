...
<html lang="en">
  ...
  <body>
    ...
    <div id="contact">
      <div class="wrapper" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="500">
        <div class="footer">
          ...
          <div class="footer-section">
            <h3>Address</h3>
            <p>Kp. Nitikan No. 240, Jl. Sorogenen No.19, Sorosutan, Kec. Umbulharjo, Kota Yogyakarta, Daerah Istimewa Yogyakarta 55162</p>
          </div>
          <div class="footer-section">
            <h3>Social Media</h3>
    ...
    <div id="copyright">
      <div class="wrapper">&copy; 2023. <b>TAPWD</b> All Rights Reserved</div>
    </div>
