        ...
        <div class="modal-dialog">
            <div style="background-color: #7ECA9C;" class="modal-content">
                ...
                <div class="modal-body">
                    <form action="function/add-staff.php" method="POST" onsubmit="return validateForm()">
...
<script>
    function validateForm() {
        ...
        if (ID_Pegawai === "" || Nama === "" || Posisi === "" || Alamat === "" || Jenis_kelamin === "" || No_Telp === "") {
            alert("Harap isi semua kolom!");
            return false;
        }

        if (isNaN(ID_Pegawai) || isNaN(No_Telp)) {
            alert("ID Pegawai dan No Telp harus berupa angka!");
            return false;
        }
