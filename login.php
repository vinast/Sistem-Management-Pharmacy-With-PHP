            ...
            <div id="login" class="col col-lg-4 kotak1">
                ...
                <div class="margin">
                    ...
                    <form class="" action="cek-login.php" method="post">
                        ...
                        <div class="form-group">
                            <label style="margin-bottom: 0px; margin-left: 25px;" for="formGroupExampleInput2">Captcha</label>
                            <img src="captcha_image.php" alt="Captcha Image" style="width: 200px; height: auto;"><br><br>
                                <input style="margin-bottom: 30px; margin-left: 25px;" type="text" class="form-control" name="captcha" placeholder="Masukkan Kode Captcha..." required>
                        </div>
