...
<body>
    ...
    <div class="modal-dialog">
        ...
        <form action="function/add-kepala-barang.php" method="POST" onsubmit="return validateForm()">
...
<script>
    function validateForm() {
        ...
        if (ID_Barang === "" || nama_barang === "" || kategori === "" || harga_jual === "" || harga_beli === "" || stok === "") {
            alert("Harap isi semua Data!");
            return false;
        }

        if (isNaN(ID_Barang) || isNaN(harga_jual) || isNaN(harga_beli) || isNaN(stok)) {
            alert("ID Barang, Harga Jual, Harga Beli, dan Stok harus berupa angka!");
            return false;
        }

        if (harga_jual <= 0 || harga_beli <= 0 || stok < 0) {
            alert("Harga Jual dan Harga Beli harus lebih besar dari 0. Stok tidak boleh negatif!");
            return false;
        }
