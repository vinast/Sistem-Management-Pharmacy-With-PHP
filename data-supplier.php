...
<body>
    ...
    <div class="modal-dialog">
        ...
        <form action="function/add-supplier.php" method="POST" onsubmit="return validateForm()">
...
<script>
    function validateForm() {
        var ID_Supplier = document.getElementsByName("ID_Supplier")[0].value;
        var nama_supplier = document.getElementsByName("nama_supplier")[0].value;
        var alamat_supplier = document.getElementsByName("alamat_supplier")[0].value;
        var No_Telp = document.getElementsByName("No_Telp")[0].value;

        if (ID_Supplier === "" || nama_supplier === "" || alamat_supplier === "" || No_Telp === "") {
            alert("Harap isi semua kolom!");
            return false;
        }

        if (isNaN(ID_Supplier) || isNaN(No_Telp)) {
            alert("ID Supplier dan No Telp harus berupa angka!");
            return false;
        }
